function fullAvatarEditor() {
	...
	var file			= Think._PUBLIC_+'/static/avatareditor/fullAvatarEditor.swf';		//flash文件的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	var	expressInstall	= Think._PUBLIC_+'/static/avatareditor/expressInstall.swf';			//expressInstall.swf的路径
	var	width			= 650;							//flash文件的宽度
	var	height			= 380;							//flash文件的高度
